...
div[role="radiogroup"] > label {{ font-family: var(--font-body) !important; font-size: 0.85rem !important; color: var(--text-1) !important; }}
...
FALLBACK_CFG = {"color": "#888888", "bg": "rgba(136,136,136,0.1)", "border": "rgba(136,136,136,0.2)", "icon": "✦"}
...
<div style="font-family:'Bebas Neue',sans-serif;font-size:3.8rem;letter-spacing:3px;line-height:1;color:var(--text-1);display:flex;align-items:center;gap:12px;transition:all 0.2s ease;">
{row['Timestamp']}
<span style="background:rgba(128,0,32,0.08);color:var(--cherry);font-family:'JetBrains Mono',monospace;font-size:1rem;padding:4px 10px;border-radius:8px;font-weight:600;letter-spacing:0.5px;display:flex;align-items:center;">⧉ OPEN YOUTUBE</span>
</div>
</a>
</div>
""", unsafe_allow_html=True)
